...
// in the short term
import { adapter, init as nholuongutInit } from '../../src/nholuongut';
...
describe('adapter', function () {
  ...
  it('resolves scoped adapter paths', function () {
    ...
    // Describe an adapter
    let adapterConfig = {
      path: path.join(repoConfig.path, '/node_modules/@nholuongut/cz-conventional-changelog'),
      npmName: '@nholuongut/cz-conventional-changelog'
    };

    // Install an adapter
    nholuongutInit(config.paths.endUserRepo, '@nholuongut/cz-conventional-changelog');
  ...
  it('gets adapter prompter functions for default export adapters', function () {
    ...
    // Install an adapter
    nholuongutInit(config.paths.endUserRepo, 'cz-conventional-changelog-default-export');
