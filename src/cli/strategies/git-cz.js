...
import { gitCz as gitCzParser, nholuongut as nholuongutParser } from '../parsers';
import { commit, staging, adapter } from '../../nholuongut';
...
function gitCz (rawGitArgs, environment, adapterConfig) {
  ...
  let parsednholuongutArgs = nholuongutParser.parse(rawGitArgs);

  if (parsednholuongutArgs.amend) {
  ...
  let hookMode = !(typeof parsednholuongutArgs.hook === 'undefined');
